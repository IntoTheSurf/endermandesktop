...
function openCity(evt, cityName) {
    ...
    evt.currentTarget.style.backgroundColor = "#d15b5b";
}
...
function closeCity(evt, cityName) {
    ...
    document.getElementById(cityName).style.display = "flex";
    document.getElementById('firstTab').style.backgroundColor = "#d15b5b";
}
...
function chooseOption(evt, cityName, tabName) {
    ...
    document.getElementById(cityName).style.display = "flex";
    document.getElementById(tabName).style.backgroundColor = "#d15b5b";
}
...
function openTask(i) {
    ...
    if (i == 0) {
        if (a == 0) {
            const task = `
    <div id="aboutTask" onclick="document.getElementById('aboutTask').style.backgroundColor = 'rgb(252, 112, 112)';">
      <div class="taskOpen" id="" onclick="document.getElementById('about').style.display='block'; switchTasks(0); document.getElementById('aboutTask').style.backgroundColor = 'rgb(252, 112, 112)';">
          ...
          <p class="taskName">About</p>
            ...
            a++;
            switchTasks(i);
            document.getElementById('aboutTask').style.backgroundColor = 'rgb(252, 112, 112)';
        }
    }
    else if (i == 1) {
        if (g == 0) {
            const task = `
    <div id="galleryTask" onclick="document.getElementById('galleryTask').style.backgroundColor = 'rgb(252, 112, 112)';">
      <div class="taskOpen" onclick="openModal(); switchTasks(1); document.getElementById('galleryTask').style.backgroundColor = 'rgb(252, 112, 112)';">
        ...
        <p class="taskName">Gallery</p>
            ...
            g++;
            switchTasks(i);
            document.getElementById('galleryTask').style.backgroundColor = 'rgb(252, 112, 112)';
        }
    }
    else if (i == 2) {
        if (t == 0) {
            const task = `
    <div id="triviaTask" onclick="document.getElementById('triviaTask').style.backgroundColor = 'rgb(252, 112, 112)';">
      <div class="taskOpen" onclick="document.getElementById('trivia').style.display='block'; switchTasks(2); document.getElementById('triviaTask').style.backgroundColor = 'rgb(252, 112, 112)';">
        ...
        <p class="taskName">Trivia</p>
            ...
            t++;
            switchTasks(i);
            document.getElementById('triviaTask').style.backgroundColor = 'rgb(252, 112, 112)';
        }
    }
...
function closeTask(i) {
    ...
    if (i == 'aboutTask') {
        a--;
        document.getElementById(i).style.backgroundColor = 'rgb(216, 81, 81)';
    }
...
function switchTasks(i) {
    if (i == 0) {
        ...
        if (gTask) {
            document.getElementById('galleryTask').style.backgroundColor = 'rgb(216, 81, 81)';
            document.getElementById('gallery').style.zIndex = 2;
        }
        var trTask = document.getElementById("triviaTask");
        if (trTask) {
            document.getElementById('triviaTask').style.backgroundColor = 'rgb(216, 81, 81)';
        ...
        var abTask = document.getElementById("aboutTask");
        if (abTask) {
            document.getElementById('aboutTask').style.backgroundColor = 'rgb(216, 81, 81)';
...
function closeStart() {
    ...
    document.getElementById('homeContainer').style.backgroundColor = 'rgb(216, 81, 81)';
...
document.addEventListener('click', function (event) {
    ...
    if (!isClickInside && !isClickInside2) {
        ...
        if (startVar == 0) {
            ...
            document.getElementById('homeContainer').style.backgroundColor = 'rgb(252, 112, 112)';
            startVar++;
        }
        else {
            document.getElementById('start').style.display = 'none';
...
var pigstep = document.getElementById('pigstepplayer');
pigstep.volume = 0.1;
var pigstepshow = 1;

function changeTechno() {
    let pigsty = document.getElementById('pigstepcontainer');
    if (pigstepshow==0) {
        pigsty.style.display = 'block';
    ...
    else if (pigstepshow==1){
        pigsty.style.display = 'none';
        document.getElementById('technoImg').src = "./images/technoblade/technoblade-flop-min-nmlh.webp";
        document.getElementById('technoImg').style.width = '75px';
        pigstepshow--;
    }
}
